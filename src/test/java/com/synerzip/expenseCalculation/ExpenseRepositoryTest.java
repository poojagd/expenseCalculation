...
public class ExpenseRepositoryTest {
  ...
  public void testFindByUserId() throws JSONException, ParseException {
    ...
    Expense expense3 = new Expense(user, id, "demo", category, null, 900, "description","Electricity");
    ...
    ArrayList<Expense> foundExpenses = (ArrayList<Expense>) expenseRepository.findByUserId(expense1.getUserId());
